...
class Env(tk.Tk):
    ...
    def rotate(self, dir):
        ...
        for i in range(len(self.block)):
            ...
            # y
            next_block[i][1] = s[1] + pos[self.curr_block][(self.curr_block_type + dir) % curr_size][i][1] - \
                               pos[self.curr_block][self.curr_block_type][i][1]
            # x
            next_block[i][0] = s[0] + pos[self.curr_block][(self.curr_block_type + dir) % curr_size][i][0] - \
                               pos[self.curr_block][self.curr_block_type][i][0]
        ...
        for i in range(len(self.block)):
            self.canvas.move(self.block[i],
                             pos[self.curr_block][(self.curr_block_type + dir) % curr_size][i][0] -
                             pos[self.curr_block][self.curr_block_type][i][0],
                             pos[self.curr_block][(self.curr_block_type + dir) % curr_size][i][1] -
                             pos[self.curr_block][self.curr_block_type][i][1])
